...
func Test_GetAddressPubKeySECP256K1_Zero(t *testing.T) {
	...
	assert.Equal(t, "iq1uayrf8zh44620zyjd052gdcjcrvjpgkkg78fux", addr, "Unexpected addr")
}
...
func Test_GetAddressPubKeySECP256K1(t *testing.T) {
	...
	assert.Equal(t, "iq1ql0ggyut5pkytffp94q3xv5zzwezq2cwv5qxc0", addr, "Unexpected addr")
}
